...
import { findPlansByProduct, insertPlan, selectPlan } from './api/plan/plan.model'
import { selectProduct, upsertProduct } from './api/product/product.model'
...
const planRouter = {
  ...
  insert: oc.input(insertPlan).output(z.void()),
}
